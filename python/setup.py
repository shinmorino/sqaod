...
if platform.system() != 'Windows' :
    ...
    ext_modules.append(new_ext('sqaod.cuda.cuda_dg_bf_searcher', ['sqaod/cuda/src/cuda_dg_bf_searcher.cpp']))
    ext_modules.append(new_ext('sqaod.cuda.cuda_dg_annealer', ['sqaod/cuda/src/cuda_dg_annealer.cpp']))
    ext_modules.append(new_ext('sqaod.cuda.cuda_bg_bf_searcher', ['sqaod/cuda/src/cuda_bg_bf_searcher.cpp']))
    ext_modules.append(new_ext('sqaod.cuda.cuda_bg_annealer', ['sqaod/cuda/src/cuda_bg_annealer.cpp']))
    ext_modules.append(new_ext('sqaod.cuda.cuda_formulas', ['sqaod/cuda/src/cuda_formulas.cpp']))
