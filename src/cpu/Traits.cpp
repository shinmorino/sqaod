...
template<class real>
void SolverTraits<real>::rbmCalculate_hJc(real *h0, real *h1, real *J, real *c,
                                          const real *b0, const real *b1, const real *W,
                                          int N0, int N1) {
...
template<class real>
void SolverTraits<real>::
rbmCalculate_E_fromQbits(real *E,
...
template<class real>
void SolverTraits<real>::
rbmBatchCalculate_E_fromQbits(real *E,
                              const real *h0, const real *h1, const real *J, real c,
                              const char *q0, const char *q1,
                              int N0, int N1, int nBatch0, int nBatch1) {
