...
template<class real>
void CPUBipartiteGraphBFSearcher<real>::getProblemSize(int *N0, int *N1) const {
    *N0 = N0_;
    *N1 = N1_;
}
...
template<class real>
void CPUBipartiteGraphBFSearcher<real>::setTileSize(SizeType tileSize0, SizeType tileSize1) {
...
template<class real>
void CPUBipartiteGraphBFSearcher<real>::search() {
    initSearch();
